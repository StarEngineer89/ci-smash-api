...
$route['api/order/add'] = 'api/order/identify';
$route['api/order/order'] = 'api/order/order';
$route['api/order/list'] = 'api/order/list';

$route['api/reward/donate'] = 'api/reward/donate';
