...
$config['facebook_app_id']              = '138931356770806';
$config['facebook_app_secret']          = '399dc1cce8d531a00f8fd4c4ba2fe113';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'thesmashapp.com/api/user/login';
$config['facebook_logout_redirect_url'] = 'thesmashapp.com/api/user/logout';
